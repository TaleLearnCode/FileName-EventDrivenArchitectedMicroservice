...
internal static partial class CreateModel
{
	...
	internal static void ResidentPostalAddressType(ModelBuilder modelBuilder)
	{
		modelBuilder.Entity<ResidentPostalAddressType>(entity =>
		{
			entity.HasKey(e => e.PostalAddressTypeId)
					.HasName("pkcPostalAddressType");

			entity.ToTable("ResidentPostalAddressType", "RM");

			entity.HasComment("Lookup values representing phone number types used by Glennis.");

			entity.HasIndex(e => e.ExternalId, "unqResidentPostalAddressType_ExternalId")
					.IsUnique()
