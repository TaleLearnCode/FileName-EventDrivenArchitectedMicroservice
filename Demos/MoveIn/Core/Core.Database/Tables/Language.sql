...
GO
EXEC sp_addextendedproperty @level0name=N'Core', @level1name=N'Language', @level2name=N'pkcLangauge',  @value=N'Defines the primary key for the Language table using the LanguageCode column.', @name=N'MS_Description', @level0type=N'SCHEMA', @level1type=N'TABLE', @level2type=N'CONSTRAINT';
GO